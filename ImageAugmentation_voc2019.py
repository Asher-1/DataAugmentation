...
if __name__ == '__main__':
    ...
    # ROOT_PATH = './test'
    ROOT_PATH = '/media/yons/data1/dataset/images/helmet_worker/VOC2019'
    ...
    seq = Sequence([RandomHSV(40, 40, 30), RandomHorizontalFlip(p=0.5),
                    RandomNoise(p=0.4, mode='gaussian'),
                    RandomLight(p=0.5, light=(0.5, 1.5)),
                    RandomTranslate(diff=True), RandomRotate(20),
                    RandomShear(0.05)])
